...
function PopupNavigation(props) {
  ...
  return (
    ...
    <div className='popup__container'>
        <button className='popup__close' type='button' onClick={handleCloseData}></button>
        <Link to='/'  className={props.isGlavnay ?'popup__link popup__link_glavnay popup__link_active': "popup__link popup__link_glavnay"}>Главная</Link>
